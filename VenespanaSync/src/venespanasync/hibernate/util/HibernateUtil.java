...
public class HibernateUtil {
    ...
    private static String serverUrl = "190.9.44.82:3306/venespan_ocar341?autoReconnect=true";
    private static String user = "venespan_ocar341";
    private static String pwd = "DMp8gS61@-";
    ...
    public static final int POSTGRESQLSSL = 4;
    public static final int POSTGRESQLSSLNOVEF = 5;
    public static final int H2DATABASE = 6;
    public static final int H2DATABASEEMBEDDED = 7;
    public static final int H2DATABASEMEMORY = 8;
    private static SessionFactory sessionFactory = null;

    private static void rebuildSessionFactory() throws HibernateException {
        switch (dbType) {
            case (MSSQL):
